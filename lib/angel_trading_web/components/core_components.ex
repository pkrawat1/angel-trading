defmodule AngelTradingWeb.CoreComponents do
  @moduledoc """
  ...
  def modal(assigns) do
    ...
    >
      ...
      <div
        class="fixed inset-0 overflow-y-auto dark:backdrop-blur-sm dark:bg-gray-950/80"
          ...
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            ...
            >
              <div class="absolute top-6 right-5">
                ...
                >
                  <.icon name="hero-x-mark-solid dark:text-gray-200" class="h-5 w-5" />
                </button>
              </div>
              <div id={"#{@id}-content"}>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AngelTradingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AngelTradingWeb.Gettext, "errors", msg, opts)
    end
  end
